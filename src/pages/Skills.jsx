...
export default function Skills() {
  ...
  return (
    <main style={{ paddingTop: '80px', backgroundColor: 'var(--bg-primary)' }}>
      <section
        ref={scrollRef}
        ...
        <div className="container position-relative" style={{ zIndex: 1 }}>
          ...
          >
            <div className="position-absolute start-50 top-0 bottom-0 tech-timeline-vertical" style={{ transform: 'translateX(-50%)', width: '4px' }}>
              <div className="position-absolute top-0 start-0 w-100 h-100 rounded" style={{ opacity: 0.3, borderRadius: '2px', backgroundColor: 'var(--border-subtle)' }} />
